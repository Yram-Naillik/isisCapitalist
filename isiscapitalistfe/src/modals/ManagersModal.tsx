          ...
          <div className="managersList">
            <div className="managersLeftSide">
              <div className="managersComponent">
                ...
                <div>
                  <div className="managerName">{world.managers[0].name}</div>
                  <div className="managerText">
                  <div>{world.products[world.managers[0].idcible - 1].name}</div>
              ...
              <div className="managersComponent">
                ...
                <div>
                  <div className="managerName">{world.managers[1].name}</div>
                  <div className="managerText">
                  <div>{world.products[world.managers[1].idcible - 1].name}</div>
              ...
              <div className="managersComponent">
                ...
                <div>
                  <div className="managerName">{world.managers[2].name}</div>
                  <div className="managerText">
                  <div>{world.products[world.managers[2].idcible - 1].name}</div>
            ...
            <div className="managersRightSide">
              <div className="managersComponent">
                ...
                <div>
                  <div className="managerName">{world.managers[3].name}</div>
                  <div className="managerText">
                  <div>{world.products[world.managers[3].idcible - 1].name}</div>
              ...
              <div className="managersComponent">
                ...
                <div>
                  <div className="managerName">{world.managers[4].name}</div>
                  <div className="managerText">
                  <div>{world.products[world.managers[4].idcible - 1].name}</div>
              ...
              <div className="managersComponent">
                ...
                <div>
                  <div className="managerName">{world.managers[5].name}</div>
                  <div className="managerText">
                  <div>{world.products[world.managers[5].idcible - 1].name}</div>
